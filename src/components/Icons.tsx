...
export function InstagramIcon({ className }: Icon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function GithubIcon({ className }: Icon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function GoogleBrand({ className }: Icon) {
  return (
    <svg
      width="256"
      height="262"
...
export function GithubBrand({ className }: Icon) {
  return (
    <svg
      width="1024"
      height="1024"
...
export function SunIcon({ className }: Icon) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
